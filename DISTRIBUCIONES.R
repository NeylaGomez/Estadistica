...
# y sólo una de ellas es correcta. Encuentre la probabilidad de 
...
# Dado que sólo una de cada cinco respuestas posibles es correcta, 
# la probabilidad de responder correctamente una pregunta al azar 
# # es de 1/5=0.2. Podemos encontrar la probabilidad de tener 
# exactamente 4 respuestas correctas por intentos aleatorios de 
# la siguiente manera:
...
# 4.- Función en R: Se utiliza la fumción *dbinom(k, n, p)*, 
# se pueden solo poner las letras o se sustituyen los valores.
...
# mismo de valor de "x", de "n" y la probailidad es la que va a ir 
...
# de matemáticas. Cada pregunta tiene cinco posibles respuestas, 
# y sólo una de ellas es correcta. Encuentre la probabilidad de 
# tener cuatro o menos respuestas correctas si un estudiante intenta 
...
# en esta ocasión se ocuparán valores de **5, 10 y 20*. 
...
# de los estudiantes evitando las aglomeraciones se requiere saber la 
...
# sin embargo se debe modificar el valor de lambda para que se 
# pueda observar bien el gráfico, pero el valor de "x" sigue igual, 
