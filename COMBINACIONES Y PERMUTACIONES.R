...
# 1. Se quieren realizar equipos de 2 integrantes con 
# los alumnos tercer grado de la escuela 
# primaria "Lázaro Cárdenas del Río. En total se 
# tienen 100 alumnos. 
...
# 1. Se quieren realizar equipos de 4 integrantes con los
# alumnos de tercer grado de la escuela primaria 
# "Lázaro Cárdenas del Río. En total se tiene 100 alumnos. 

# N = 100 - Número de elementos 

# n = 4 - Grupos de 3 en 3
